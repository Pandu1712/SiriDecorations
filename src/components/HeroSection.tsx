...
const HeroSection = () => {
  return (
    <section className="bg-gradient-to-r from-pink-500 via-purple-600 to-indigo-700 text-white py-20 md:py-32 px-6">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        >
          <img
            ...
            className="rounded-3xl shadow-2xl w-80 md:w-[450px] h-auto hover:scale-105 transition-transform duration-500"
          />
        </motion.div>
        ...
        >
          ...
          <motion.a
            ...
            className="inline-block bg-white text-purple-700 font-semibold px-8 py-3 rounded-full shadow-lg hover:bg-yellow-300 transition-all"
          >
